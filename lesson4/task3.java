...
public class task3 {
    public static void main(String[] args) {
        ...
        System.out.println(
               "Добрый день, калькулятор на связи!!\nЯ помогу Вам сложить, вычесть, поделить или умножить числа. " +
                        "или /\nЕсли Вы введете слово 'Отмена', то я отменю последнее действие и верну предыдущий результат");
    ...
    public static double input_number(Scanner scanner) {
        ...
        try {
            ...
            System.out.println("Вы не ввели число. Попробуйте еще раз");
            scanner.nextLine();
